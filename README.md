...
## Project Description
A system-level C program that simulates hospital emergency room operations. It covers process management, IPC, CPU scheduling, synchronization, and memory allocation using real OS concepts.
...
*   `pthread`, `semaphore`, `sys/shm` libraries.
...
### How to Run
You can use the provided Makefile or run the scripts manually:
```bash
make run
# OR
./start_hospital.sh
